...
public class _DBService {
	...
	public  void instantiateTestDatabase() throws ParseException, IOException {
		...
		Reserva rsv1 = new Reserva(01, sdf.parse("2022-05-18"), sdf.parse("2022-05-25"), 0.0F, 12,cl1, lvr1);
		Reserva rsv2 = new Reserva(02, sdf.parse("2022-05-18"), sdf.parse("2022-06-12"), 0.0F, 12,cl2, lvr2);
